...
setup(
    ...
    entry_points={
        'console_scripts': [
            'joint_controller = butterfly.joint_controller:main',  # Entry point for the joint_controller script
            # Add executable scripts here if needed
            'transform_broadcaster = butterfly.transform_broadcaster:main',
